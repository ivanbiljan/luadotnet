...
public class MethodTests
{
    ...
    public class Test
    {
        ...
        public int Method2(params int[] @params)
        {
            return @params.Sum() + 1;
        }

        public bool Method2(bool firstArg)
        {
            return firstArg;
        }

        public string Method2(string firstArg)
        {
            return firstArg;
        }

        public int Method2(int firstArg)
        {
            return firstArg;
        }

        public double Method2(double firstArg)
        {
            return firstArg;
        }

        public int Method2(int firstArg, int secondArg)
        {
